                    ...
                    <div class="tab-content my-1 mt-4 " id="filterTabsContent">
                        ...
                        <div class="tab-pane fade" id="programs-filter" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4 form-group" id="domains">
                                    ...
                                    <select id="domain_id" name="domain" class="form-select program-filter">
                                        ...
                                        @foreach($superDomains as $supDomain)
                                        <optgroup label="{{ __('schools.' . $supDomain->name) }}">
                                            @foreach($supDomain->domains as $domain)
                                                <option value="{{ $domain->id }}" @selected(request('domain') == $id)>{{ $domain->name }}</option>
                                            @endforeach
                                        </optgroup>
                                        @endforeach
                                    </select>
