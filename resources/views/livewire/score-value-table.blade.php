<div>
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <input type="text" wire:model.live.debounce.500ms="searchCriteria" class="form-control" placeholder="Search Criteria Name">
        </div>
        <div class="col-md-4">
            <input type="text" wire:model.live="searchEntityType" class="form-control" placeholder="Search Entity Type (e.g. TelecomOffer)">
        </div>
    </div>
